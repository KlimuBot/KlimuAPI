...
public interface UserNotificationService {
    ...
    List<UserNotification> getUserNotificationsByChannel(List<Channel> channels);
    List<UserNotification> getUserNotificationsByNotification(LocalizedNotification localizedNotification);
    List<UserNotification> getUserNotificationsByNotification(List<LocalizedNotification> localizedNotifications);
